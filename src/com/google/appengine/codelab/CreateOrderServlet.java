...
public class CreateOrderServlet extends HttpServlet {
  ...
  private void createOrder(HttpServletRequest req, HttpServletResponse resp)
    ...
    String mailContent ="";
    logger.log(Level.INFO, "got the parameter {0}", xmlString);
    ...
    OrderBooking orderBooking;
  	try {
  	  ...
  	  for(Order ord : orderBooking.getOrder()){
          ...
          Util.Logging("order has been created with id " +String.valueOf(recentId));
  	  }
  	  logger.log(Level.INFO, "orders have been created from the file you uploaded {0}", mailContent);
